...
import argparse
# slots_template = ['OBJ-ENTITY', 'OBJ-NAME', 'PLACE-HERE', 'OBJ-PRODUCT', 'ASK-MINUTE', 'ASK-KM', \
#             'REF-LEVEL', 'REF-NAME', 'NUM-KILOMET', 'NUM-MINUTE', 'USER-HOUSE', 'USER-WORKPLACE', 'VEHICLE']
...
class Evaluator():
    ...
    def evaluate(self, type_matching):
        ...
        skip_slots = ['NUM-KILOMET', 'NUM-MINUTE', 'USER-HOUSE', 'USER-WORKPLACE', 'VEHICLE']
        ...
        for skip in skip_slots:
            if skip in self.slots_template:
                self.slots_template.remove(skip)
